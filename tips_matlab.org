...
*** legend
    legendas
    legend('ERROR','Converg LINEAL','Converg CUAD','location','SouthEas')
...
** hdf5
   Hierarchical Data Format, is a set (struct) of file formats designed to store large amount of data
*** open hdf5
